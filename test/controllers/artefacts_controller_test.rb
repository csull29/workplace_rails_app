...
class ArtefactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artefact" do
    assert_difference('Artefact.count') do
      post artefacts_url, params: { artefact: { key: @artefact.key, name: @artefact.name, project_id: @artefact.project_id } }
    end
  ...
  test "should update artefact" do
    patch artefact_url(@artefact), params: { artefact: { key: @artefact.key, name: @artefact.name, project_id: @artefact.project_id } }
